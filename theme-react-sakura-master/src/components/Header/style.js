...
export const Headers = styled.div`
    ...
    .search-form .search_close {
        ...
        top: 20px;
        right: 15px;
        cursor: url('http://static.lhanman.cn/static/assets/sakura/static/media/ayuda.4f1cd0e7.cur'),auto;
    }
...
export const IconBox = styled.div`
    i{
        ...
        margin-left:20px;
        color:#666666;
        cursor: url('http://static.lhanman.cn/static/assets/sakura/static/media/ayuda.4f1cd0e7.cur'),auto !important;
    }
    i:hover{
        color:#fe9600;
    }
